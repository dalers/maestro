...
# - FORCE UNIX EOL when flip known to misinterpret file type
#
...
/usr/local/bin/mysql -uroot -pHarvey57 --local-infile=1 --show-warnings --verbose < /usr/local/www/maestro/protected/data/drop_and_create_tables.sql
echo ""

# load csv data files
echo "Loading CSV files..."
/usr/local/bin/mysql -uroot -pHarvey57 --local-infile=1 --show-warnings --verbose < /usr/local/www/maestro/protected/data/load_maestro_unix.sql
echo ""
