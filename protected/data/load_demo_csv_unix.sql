...
--
-- normally executed from load_demo_csv_unix.sh
-- assumes csv files have unix EOL marker
-- file paths hardcoded for server
--
-- > mysql -uroot -p --local-infile=1 --show-warnings --verbose < /path/to/load_demo_csv_unix.sql
--
