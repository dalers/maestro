...
class Issue extends CActiveRecord
{
    ...
    public function search()
    {
        ...
        //winesett (trackstar) code breaks on-the-fly search and advanced
        //search by rewriting previously prepared conditions
        ...
        //
        //project_id is set before calling search, so no reason to add complication
        //i.e. project condition code can be left as-is (as generated by gii)
        $criteria->compare('project_id',$this->project_id);
