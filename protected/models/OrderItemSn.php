...
/**
 * This is the model class for table "tbl_order_item_sn".
 *
 * The followings are the available columns in table 'tbl_order_item_sn':
 * @property integer $id
 * @property integer $order_item_id
 * @property integer $stock_serial_id
 *
 * The followings are the available model relations:
 * @property TblOrderItem $orderItem
 * @property TblStockSerial $stockSerial
 */
class OrderItemSn extends CActiveRecord
{
	/**
	 ...
	 * @return OrderItemSn the static model class
	 */
