...
class OmOrderItemController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('OmOrderItem');
	...
	{
		$model=new OmOrderItem('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['OmOrderItem']))
			$model->attributes=$_GET['OmOrderItem'];
	 ...
	 * @return OmOrderItem the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=OmOrderItem::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param OmOrderItem $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='om-order-item-form')
		{
